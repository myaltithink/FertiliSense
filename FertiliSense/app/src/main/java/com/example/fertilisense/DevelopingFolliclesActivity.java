...
public class DevelopingFolliclesActivity extends AppCompatActivity {

    private BottomNavigationView bottomNavigationView;
    private FirebaseAuth authProfile;
    private FirebaseUser currentUser;
    private static final String TAG = "DevelopingFolliclesActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_developing_follicles);
        ...
        if (actionBar != null) {
            actionBar.setTitle("Ovarian Follicles Activity");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    Log.d("FertiliSense", "Navigating to DevelopingFolliclesActivity");
                    Intent intent = new Intent(DevelopingFolliclesActivity.this, FemaleReproductiveSystemActivity.class);
                    ...
                    // Intent intent = new Intent(DevelopingFolliclesActivity.this, CalendarActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                } else if (id == R.id.home) {
                    Log.d(TAG, "Dashboard clicked");
                    Intent intent = new Intent(DevelopingFolliclesActivity.this, FertiliSenseDashboardActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                    finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(DevelopingFolliclesActivity.this, SearchActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(DevelopingFolliclesActivity.this, SymptomsActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                }
