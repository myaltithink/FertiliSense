...
public class MaleReproductiveSystemMenActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    ...
                    Intent intent = new Intent(MaleReproductiveSystemMenActivity.this, ChatBotActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
            ...
            referenceProfile.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        if (photoUri != null) {
                            Picasso.with(MaleReproductiveSystemMenActivity.this)
                                    .load(photoUri)
                        ...
                        Toast.makeText(MaleReproductiveSystemMenActivity.this, "User data not found", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(MaleReproductiveSystemMenActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                }
            });

            // Set a click listener to open UserProfileActivity
            headerView.setOnClickListener(v -> {
                Intent intent = new Intent(MaleReproductiveSystemMenActivity.this, UserProfileActivity.class);
                startActivity(intent);
            });
        } else {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.share_us) {
            ...
            Intent intent = new Intent(MaleReproductiveSystemMenActivity.this, FeedbackActivity.class);
            startActivity(intent);
            overridePendingTransition(0, 0);
            finish();
            ...
            Intent intent = new Intent(MaleReproductiveSystemMenActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        }
