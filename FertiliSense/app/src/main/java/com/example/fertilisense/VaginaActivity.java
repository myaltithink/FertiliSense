...
public class VaginaActivity extends AppCompatActivity {

    private BottomNavigationView bottomNavigationView;
    private FirebaseAuth authProfile;
    private FirebaseUser currentUser;
    private static final String TAG = "VaginaActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vagina);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    ...
                    Intent intent = new Intent(VaginaActivity.this, FemaleReproductiveSystemActivity.class);
                    ...
                    // Intent intent = new Intent(VaginaActivity.this, SearchActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                } else if (id == R.id.symptoms) {
                    Log.d(TAG, "Symptoms clicked");
                    // Intent intent = new Intent(VaginaActivity.this, SymptomsActivity.class);
                    // startActivity(intent);
                    overridePendingTransition(0,0);
                    // finish();
                }
