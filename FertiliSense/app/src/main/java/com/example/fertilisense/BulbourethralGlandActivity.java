...
public class BulbourethralGlandActivity extends AppCompatActivity {

    private BottomNavigationView bottomNavigationView;
    private FirebaseAuth authProfile;
    private FirebaseUser currentUser;
    private static final String TAG = "BulbourethralGlandActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bulbourethral_gland);
        ...
        if (actionBar != null) {
            actionBar.setTitle("Bulbourethral Gland Activity");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    ...
                    Intent intent = new Intent(BulbourethralGlandActivity.this, MaleReproductiveSystemActivity.class);
                    ...
                    // Intent intent = new Intent(BulbourethralGlandActivity.this, CalendarActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                } else if (id == R.id.home) {
                    Log.d(TAG, "Dashboard clicked");
                    Intent intent = new Intent(BulbourethralGlandActivity.this, FertiliSenseDashboardActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                    finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(BulbourethralGlandActivity.this, SearchActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(BulbourethralGlandActivity.this, SymptomsActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                }
