...
public class FallopianTubeActivity extends AppCompatActivity {

    private BottomNavigationView bottomNavigationView;
    private FirebaseAuth authProfile;
    private FirebaseUser currentUser;
    private static final String TAG = "FallopianTubeActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fallopian_tube);
        ...
        if (actionBar != null) {
            actionBar.setTitle("Fallopian Tube Activity");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    ...
                    Intent intent = new Intent(FallopianTubeActivity.this, FemaleReproductiveSystemActivity.class);
                    ...
                    // Intent intent = new Intent(FallopianTubeActivity.this, CalendarActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                } else if (id == R.id.home) {
                    Log.d(TAG, "Dashboard clicked");
                    Intent intent = new Intent(FallopianTubeActivity.this, FertiliSenseDashboardActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                    finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(FallopianTubeActivity.this, SearchActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(FallopianTubeActivity.this, SymptomsActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                }
