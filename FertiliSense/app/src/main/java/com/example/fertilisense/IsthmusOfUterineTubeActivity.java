...
public class IsthmusOfUterineTubeActivity extends AppCompatActivity {

    private BottomNavigationView bottomNavigationView;
    private FirebaseAuth authProfile;
    private FirebaseUser currentUser;
    private static final String TAG = "IsthmusOfUterineTubeActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_isthmus_of_uterine_tube);
        // Set up the toolbar
        ...
        if (actionBar != null) {
            actionBar.setTitle("Isthmus of Uterine Tube Activity");
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    Log.d("FertiliSense", "Navigating to IsthmusOfUterineTubeActivity");
                    Intent intent = new Intent(IsthmusOfUterineTubeActivity.this, FemaleReproductiveSystemActivity.class);
                    ...
                    // Intent intent = new Intent(IsthmusOfUterineTubeActivity.this, CalendarActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                } else if (id == R.id.home) {
                    Log.d(TAG, "Dashboard clicked");
                    Intent intent = new Intent(IsthmusOfUterineTubeActivity.this, FertiliSenseDashboardActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0,0);
                    finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(IsthmusOfUterineTubeActivity.this, SearchActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                    ...
                    // Uncomment and complete as needed
                    // Intent intent = new Intent(IsthmusOfUterineTubeActivity.this, SymptomsActivity.class);
                    // startActivity(intent);
                    // overridePendingTransition(0,0);
                    // finish();
                }
