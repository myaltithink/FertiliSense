...
public class MaleReproductiveSystemActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.genital) {
                    ...
                    Intent intent = new Intent(MaleReproductiveSystemActivity.this, ReportActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
        ...
        if (currentUser != null) {
            ...
            db.collection("menstrual_cycles")
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(MaleReproductiveSystemActivity.this, "Error checking cycle data", Toast.LENGTH_SHORT).show();
                    });
        } else {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.share_us) {
            ...
            Intent intent = new Intent(MaleReproductiveSystemActivity.this, UserManualActivity.class);
            startActivity(intent);
            overridePendingTransition(0, 0);
            finish();
